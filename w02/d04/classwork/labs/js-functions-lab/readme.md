...
1. Write a function that returns the number of arguments passed to the function when called.

- Define a function `maxOfN()` that takes any amount of numbers as **arguments**  and returns the largest of them.
  - **Do NOT use Math.max!**
  - Your parameters should expect numbers, not an array. hint: use a for/in over the arguments object
...
### Use only higher-order functions for these!
